...
private:
	...
	/*estados*/
		...
		/*NET CREATED*/					{{netcreated,TX(RutaDefault)},		{netcreated,TX(RutaDefault)},				{netcreated,TX(RutaDefault)},		{netcreated,TX(RutaDefault)},		{netcreated,TX(RutaDefault)},		{netcreated,TX(RutaDefault)} },
