...
FullMinerNode::FullMinerNode(boost::asio::io_context & io_context_, unsigned int ID_, std::string IP_, unsigned int port_, unsigned int randomTime_) : FullNode(io_context_, ID_, IP_, port_, randomTime_)
{
}
...
void FullMinerNode::mineBlock(void)
{
	...
	json minerTx_ = getMinerFee(true);
